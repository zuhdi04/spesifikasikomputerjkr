...
?>
    ...
    <div class="content">
        ...
        <form method="POST" action="">
            <label for="fullname">NAMA PENUH:</label><input type="text" name="Nama Penuh" id="fullname" value="<?php echo $data['nama_penuh']; ?>" required><br>
            <label for="second">BAHAGIAN / CAWANGAN / DAERAH:</label><input type="text" name="" id="second" value="<?php echo $data['bahagian_cawangan_daerah']; ?>"><br>
            <label for="third">JAWATAN DAN GRED:</label><input type="text" name="jawatangred" id="third" value="<?php echo $data['jawatan_gred']; ?>"><br>
            ...
            <label for="fifth">JENIS KOMPUTER: PERSEKUTUAN / SUK / PROJEK</label><input type="text" name="jenispc" id="fifth" value="<?php echo $data['jenis_komputer']; ?>"><br>
            <label for="pcage">UMUR KOMPUTER:</label><input type="text" name="" id="pcage" value="<?php echo $data['umur_komputer']; ?>">TAHUN<br>
            JENIS PROCESSOR:
            ...
            <input id="OTHERS" type="radio" name="proc" value="OTHERS">OTHERS:<input type="text" name="" id="otherProcTxtBox" disabled><br>
            ...
            <label for="antivirus">ANTIVIRUS:</label><input type="text" name="antivirus" id="antivirus" value="<?php echo $data['antivirus']; ?>"><br>
            <label for="ipaddress">IPV4 ADDRESS:</label><input type="text" name="ipaddress" id="ipaddress" value="<?php echo $data['ipv4_address']; ?>"><br>
            <label for="catatan">CATATAN:</label><input type="text" name="catatan" id="catatan" value="<?php echo $data['catatan']; ?>"><br>
